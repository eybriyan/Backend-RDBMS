...
<form action = "" method = "post">
 	...
 	<div class="tab1">
 		...
 		<table>
 		<p class="Header1">Add Client Information</p>
 		<hr>
 			<p>Client Name:</p><input class="int1" type = "text" name = "client_name" values = "<?php echo $client_name?>" placeholder = "Company Name"> <br/>
 			...
 			<input type= "submit" name = "submit" value = "Add" class="mybutton1">
		 	<input type = "submit" name ="canceladdclient" value = "Cancel" class="mybutton1">
 		</table>
 		</br>	
 		<br>
 	</div>
