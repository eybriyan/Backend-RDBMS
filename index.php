<html>
<head>
	<title>Shoe Transaction System</title>
</head>
<style>
body {
...
<h2 class="employee">Employee Login</h2>
	<div id="Sign-In" class="Login">  
			<form method="POST" action="home.php">
				<input type="text" name="user" size="40" class="username" placeholder ="Username">
				<input type="password" name="pass" size="40" class="password" placeholder = "Password"><br> 
