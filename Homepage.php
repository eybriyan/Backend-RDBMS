...
.TableID {
	...
	height:20%;
	margin:0px;padding:0px;
}.TableID tr:last-child td:last-child {
	-moz-border-radius-bottomright:3px;
	-webkit-border-bottom-right-radius:3px;
	border-bottom-right-radius:3px;
}
.TableID table tr:first-child td:first-child {
	-moz-border-radius-topleft:3px;
	-webkit-border-top-left-radius:3px;
	border-top-left-radius:3px;
}
.TableID table tr:first-child td:last-child {
	-moz-border-radius-topright:3px;
	-webkit-border-top-right-radius:3px;
	border-top-right-radius:3px;
}.TableID tr:last-child td:first-child{
	-moz-border-radius-bottomleft:3px;
	-webkit-border-bottom-left-radius:3px;
	border-bottom-left-radius:3px;
}.TableID tr:hover td{
...
}.TableID tr td:last-child{
	border-width:0px 0px 1px 0px;
}.TableID tr:last-child td:last-child{
	border-width:0px 0px 0px 0px;
}
.TableID tr:first-child td{
...
.TableID tr:first-child:hover td{
	background:-o-linear-gradient(bottom, #cccccc 5%, #b2b2b2 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #cccccc), color-stop(1, #b2b2b2) );
	background:-moz-linear-gradient( center top, #cccccc 5%, #b2b2b2 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#cccccc", endColorstr="#b2b2b2");	background: -o-linear-gradient(top,#cccccc,b2b2b2);
...
.TableID tr:first-child td:first-child{
	border-width:0px 0px 1px 0px;
}
.TableID tr:first-child td:last-child{
	border-width:0px 0px 1px 1px;
}
