...
if(isset($_SESSION['username'])){
 	function renderForm($client_id, $client_name, $client_contactperson, $client_address, $error)
 	{
	 	...
	 	<center>
	 			<div class="tab1">
	 				<table>
	 				<p class="Header1">Edit Client Information</p>
	 				<hr>
	 					<!--<p><strong>Client ID:</strong> <?php echo $client_id; ?></p>	-->
 							<p>Client Name:</p> <input class="int1" type="text" name="client_name" value="<?php echo $client_name; ?>" placeholder = "Company Name" /><br/>
 							<p>Contact Person:</p> <input class="int2" type="text" name="client_contactperson" value="<?php echo $client_contactperson; ?>" placeholder = "Contact"/><br/>
 							<p>Address:</p> <input class="int3" type="text" name="client_address" value="<?php echo $client_address; ?>" placeholder = "Client Address" /><br/><br/>
 							<input type="submit" name="submit_client" value="Save" class="mybutton1" >
 							<input type= "submit" name = "canceleditclient" value = "Cancel" class="mybutton1">
 					</table>
 					<br/><br/>
 				</div>
