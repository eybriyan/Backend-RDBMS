...
<div>
 		...
 		<hr>
 			<p>Supplier Name:</p><input class="int1" type = "text" name = "supplier_name" values = "<?php echo $supplier_name?>" placeholder = "Company Name"> <br/>
 			<p>Contact Person:</p><input class="int2" type = "text" name = "supplier_contactperson" value = "<?php echo $supplier_contactperson?>" placeholder = "Manager"> <br/>
 			<p>Address:</p><input class="int3" type= "text" name = "supplier_address" value = "<?php echo $supplier_address?>" placeholder= "Company Adress"> <br/>
 			<br>
 			<input type= "submit" name = "addsupplier" value = "Add" class="mybutton1">
		 	<input type = "submit" name ="canceladdsupplier" value = "Cancel" class="mybutton1">
 		</table>
 		</br>	
 		<br>
 	</div>
