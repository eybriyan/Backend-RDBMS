...
<?php 
 ...
 <form action = "" method = "post">
 	<div>
 		<strong>Add Transaction to Supplier</strong><br/><br/>
...
// if (isset($_POST['submittransact'])) {
		 if (isset($_POST['addtransact']))
 {
 	...
 	{	
 		mysql_query("INSERT INTO tbl_transaction (transaction_name, transaction_date, transaction_desc, supplier_id)
 			 values ('$transaction_name' , '$transaction_date', '$transaction_desc', '$supplier_id')")
 			or die(mysql_error());
 			//echo "success";
 			header("Location: supplier_transaction.php?supplier_id=" . $_GET['supplier_id']);
